...
const char font5x7_ref[FONT_5x7_NUM_MEMBER][FONT_5x7_NUM_BYTE] = {
   {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,},   // 0x20, Space
   {0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01,},   // 0x21, !
   {0x09, 0x09, 0x12, 0x00, 0x00, 0x00, 0x00,},   // 0x22, "
   {0x0a, 0x0a, 0x1f, 0x0a, 0x1f, 0x0a, 0x0a,},   // 0x23, #
   {0x04, 0x0f, 0x14, 0x0e, 0x05, 0x1e, 0x04,},   // 0x24, $
   {0x19, 0x19, 0x02, 0x04, 0x08, 0x13, 0x13,},   // 0x25, %
   {0x04, 0x0a, 0x0a, 0x0a, 0x15, 0x12, 0x0d,},   // 0x26, &
   {0x01, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00,},   // 0x27, '
   {0x01, 0x02, 0x04, 0x04, 0x04, 0x02, 0x01,},   // 0x28, (
   {0x04, 0x02, 0x01, 0x01, 0x01, 0x02, 0x04,},   // 0x29, )
   {0x04, 0x15, 0x0e, 0x1f, 0x0e, 0x15, 0x04,},   // 0x2a, *
   {0x00, 0x04, 0x04, 0x1f, 0x04, 0x04, 0x00,},   // 0x2b, +
   {0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x02,},   // 0x2c, ,
   {0x00, 0x00, 0x00, 0x1f, 0x00, 0x00, 0x00,},   // 0x2d, -
   {0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03,},   // 0x2e, .
   ...
   {0x00, 0x03, 0x03, 0x00, 0x03, 0x03, 0x00,},   // 0x3a, :
   {0x00, 0x03, 0x03, 0x00, 0x03, 0x01, 0x02,},   // 0x3b, ;
   ...
   {0x07, 0x02, 0x02, 0x02, 0x02, 0x02, 0x07,},   // 0x49, I
   ...
   {0x07, 0x04, 0x04, 0x04, 0x04, 0x04, 0x07,},   // 0x5b, [
   {0x10, 0x10, 0x08, 0x04, 0x02, 0x01, 0x01,},   /* 0x5c, \*/
   {0x07, 0x01, 0x01, 0x01, 0x01, 0x01, 0x07,},   // 0x5d, ]
   {0x04, 0x0a, 0x11, 0x00, 0x00, 0x00, 0x00,},   // 0x5e, ^
   {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f,},   // 0x5f, _
   {0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00,},   // 0x60, `
   {0x00, 0x0e, 0x01, 0x0d, 0x13, 0x13, 0x0d,},   // 0x61, a
   {0x08, 0x08, 0x08, 0x0e, 0x09, 0x09, 0x0e,},   // 0x62, b
   {0x00, 0x00, 0x00, 0x07, 0x08, 0x08, 0x07,},   // 0x63, c
   {0x01, 0x01, 0x01, 0x07, 0x09, 0x09, 0x07,},   // 0x64, d
   {0x00, 0x00, 0x0e, 0x11, 0x1f, 0x10, 0x0f,},   // 0x65, e
   {0x06, 0x09, 0x08, 0x1c, 0x08, 0x08, 0x08,},   // 0x66, f
   {0x00, 0x05, 0x0b, 0x0b, 0x05, 0x01, 0x0e,},   // 0x67, g
   {0x10, 0x10, 0x10, 0x16, 0x19, 0x11, 0x11,},   // 0x68, h
   {0x00, 0x02, 0x00, 0x06, 0x02, 0x02, 0x07,},   // 0x69, i
   {0x01, 0x00, 0x03, 0x01, 0x01, 0x09, 0x06,},   // 0x6a, j
   {0x08, 0x08, 0x09, 0x0a, 0x0c, 0x0a, 0x09,},   // 0x6b, k
   {0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x03,},   // 0x6c, l
   {0x00, 0x00, 0x0a, 0x15, 0x15, 0x11, 0x11,},   // 0x6d, m
   {0x00, 0x00, 0x16, 0x19, 0x11, 0x11, 0x11,},   // 0x6e, n
   {0x00, 0x00, 0x0e, 0x11, 0x11, 0x11, 0x0e,},   // 0x6f, o
   {0x00, 0x0e, 0x09, 0x09, 0x0e, 0x08, 0x08,},   // 0x70, p
   {0x00, 0x07, 0x09, 0x09, 0x07, 0x01, 0x01,},   // 0x71, q
   {0x00, 0x00, 0x0b, 0x0c, 0x08, 0x08, 0x08,},   // 0x72, r
   ...
   {0x00, 0x11, 0x11, 0x0a, 0x04, 0x04, 0x08,},   // 0x79, y
   {0x00, 0x00, 0x1f, 0x02, 0x04, 0x08, 0x1f,},   // 0x7a, z
   {0x03, 0x04, 0x04, 0x08, 0x04, 0x04, 0x03,},   // 0x7b, {
   {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,},   // 0x7c, |
